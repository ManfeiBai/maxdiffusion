...
from maxdiffusion.models.modeling_flax_pytorch_utils import convert_pytorch_state_dict_to_flax
...
def run(config):
  ...
  unet_lightning_state_dict = load_file(hf_hub_download(lightning_repo, ckpt), device="cpu")
